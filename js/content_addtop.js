...
//显示相关文章(DIY)
function show_relation_diy(source_modelid,target_modelid,id) {
	//?m=content&c=content&a=public_getjson_ids_diy&source_modelid=55&target_modelid=57&id=60
$.getJSON("index.php?m=content&c=content&a=public_getjson_ids_diy&source_modelid="+source_modelid+"&target_modelid="+target_modelid+"&id="+id, function(json){
	var newrelation_ids = '';
	if(json==null) {
		alert('没有添加相关文章');
		return false;
